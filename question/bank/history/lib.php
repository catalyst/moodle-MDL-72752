 ...
 * This fragment will pass the url of redirected page to the history page
 * as well as make sure appropriate params are passed when the page is redirected
 * from different qbank plugins like editquestion while editing a question.
 *
 * @param $args
 * @return array|string
 */
