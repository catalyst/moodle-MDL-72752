...
/**
 * Javascript for initialising show/hide dropdown, pin handle, resize handle, move handle in the column headers
 * of question bank plugin table on the "column sort order" admin page.
 *
