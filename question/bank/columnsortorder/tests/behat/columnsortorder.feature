...
Feature: A plugin column can be reordered and displayed in the question bank view.
  ...
  Scenario: Teacher can see proper view
    ...
    And I click on "Default for quiz1" "option"
  ...
  Scenario: Separation of site config and user preference
    ...
    And I am on the "Test quiz Q001" "quiz activity" page
    And I navigate to "Question bank" in current page administration
