...
class restore_move_module_questions_categories extends restore_execution_step {
        ...
        if ($this->before41) {
            ...
            foreach ($coursecategorycontexts as $coursecategorycontextid => $coursecategorycontext) {
                ...
                foreach ($questioncategories as $questioncategory) {
                    ...
                    $shortdescription = \mod_qbank\data_migration_helper::get_category_name($questioncategory->instanceid);
                    ...
                    $course = \mod_qbank\data_migration_helper::get_course($shortname, $questioncategory->instanceid);
                    if (!$course) {
                        $course = \mod_qbank\data_migration_helper::create_category_course($shortname, $questioncategory->instanceid);
                    }
                    $this->migrate_to_qbank_activities($context, $questioncategory->instanceid, $shortdescription,
    ...
    protected function migrate_to_qbank_activities($context, $instanceid, $shortdescription, $contextid, $course) {
        ...
        $qbank = \mod_qbank\data_migration_helper::create_qbank_instance($qbankname, $course);
