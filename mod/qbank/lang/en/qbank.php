...
$string['question_datamigration_course_summary'] = 'This course has been created as part of the upgrade to Moodle 4.1.
...
$string['question_datamigration_module_summary'] = 'This activity has been created as part of the upgrade to Moodle 4.1.
...
See the <a href="{$a->docs}">Question bank activity</a> for more information about how to create a Question bank correctly.';
$string['pluginadministration'] = 'Question bank administration';
$string['pluginname'] = 'Question bank';
$string['privacy:metadata'] = 'The Question bank plugin does not store any personal data, core_question automatically tracks all 
sorts of data for questions.';
